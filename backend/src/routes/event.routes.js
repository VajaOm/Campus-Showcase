...
import { createEvent, deleteEvent, getEventDetails, getEvents, addParticipate, getParticipants, removeParticipate } from '../controllers/event.controller.js';
...
router.route('/:eventId/removeParticipate').patch(veriJwt, removeParticipate)

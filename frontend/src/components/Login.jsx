            ...
            <div className='grid lg:grid-cols-12 grid-cols-1 overflow-hidden relative'>
                ...
                <div className='grid grid-cols-1 ml-10 col-span-5 sm:w-11/12 w-10/12 '>
                    ...
                    <form action="" className='grid grid-cols-1 h-full' >
                        ...
                        <input type="text" className='mt-2 p-3 rounded-lg focus:outline-none  text-black sm:w-full' placeholder='Enter your email or username' />
                        <br />
                        ...
                        <input type="password" className='mt-2 p-3 rounded-lg focus:outline-none text-black sm:w-full ' placeholder='********' />
